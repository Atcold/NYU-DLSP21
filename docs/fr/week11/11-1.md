...
Ce graphe est parfois appelé « accepteur d'états finis pondérés » (ou WFSA pour *weighted finite state accepter*). L'état gras $0$ au début est un état de départ, le cercle concentrique $3$ est un état d'acceptation. 
